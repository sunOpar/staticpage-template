...
import plumber from 'gulp-plumber'; //阻止gulp在运行时出现错误导致进程退出
...
gulp.task('styles', () => {
  ...
  return (
    gulp
      ...
      .pipe($.if('main/*.css', $.concat('style.min.css')))
...
gulp.task('clean', () => del(['.tmp', 'dist/*', '!dist/fonts'], { dot: true }));
...
gulp.task('default', ['clean'], cb =>
  runSequence('styles', ['pug', 'html', 'scripts', 'images', 'copy'], cb)
);
